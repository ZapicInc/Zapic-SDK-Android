...
public final class ZapicLoadingFragment extends Fragment {
    /**
     * The tag used to identify log messages.
     */
    @NonNull
    private static final String TAG = "ZapicLoadingFragment";
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable final Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_zapic_loading, container, false);
        ...
        closeButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                final FragmentActivity activity = ZapicLoadingFragment.this.getActivity();
                if (activity != null) {
                    activity.finish();
                }
            }
